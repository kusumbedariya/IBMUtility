...
<meta name="description"
	content=" Thyrocare Aarogyam Health Checkup Package Appointment Booking, Avail online Thyrocare Offers for Mumbai, Delhi,Kolkata, Hyderabad, navi Mumbai, Bangalore " />
<meta name="keywords"
	content="thyrocare pathology lab centres kolkata, thyrocare kolkata contact no, thyrocare service centres in kolkata, thyrocare kolkata packages, thyrocare aarogyam 1.2, thyrocare kolkata collection centers, thyrocare lab in kolkata, thyrocare bangalore offers" />
<link
...
<title>Thyrocare Health Checkup online booking</title>
</head>
		...
		<div>
			<div
				...
				<div class="flexslider effect2 effect2-contact tm-contact-box-1">
					...
					<form:form method="POST" action="/bookingsummary" id="myForm">
						<div class="tm-form-inner">
							...
							<TABLE BORDER=0 CELLPADDING=0 CELLSPACING=0 align="center"
								...
								<tr style="display: none" id="row_ben2" class="textcontent">
								...
								style="margin-left: 5px; text-transform: lowercase; width: 64%"
								required /> <br> <br>
							<textarea id="contact_message" rows="2" tabindex="23"
								placeholder="Please Enter Complete Address for Home Service"
								name="address" type="text" required style="width: 100%"></textarea>
							...
							<input name="pincode" type="text" maxlength="6" id="txt_pincode"
								...
								placeholder="Write your comment if any" style="width: 79%" /> <br>
